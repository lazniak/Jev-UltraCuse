...
| 3.7 | 3 | System Two w oknie: równoległy LLM z OpenRouter (plan 3–5 kroków, tekst na żądanie), **modal wyboru modelu** (lista `/models` OpenRouter, ulubione), bez blokowania pętli Jev; limit wywołań/zadanie | wybór modelu w ustawieniach; plan widoczny w logu; średnia liczba wywołań Jev/zadanie −30 % | todo (życzenie użytkownika 2026-09-20) | |
