...
| 0.5 | 0 | Zdalne repo: **`lazniak/Jev-UltraCuse` (prywatne, 2026-09-20)**; CI `.github/workflows/ci.yml` (fmt, clippy, test, build, artefakt exe) w PR MVP; **do zrobienia**: ochrona `main` (PR + squash + wymagany check `ci`) po pierwszym zielonym przebiegu | zielony pierwszy PR | in progress | fable |
