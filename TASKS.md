...
| 0.5 | 0 | Zdalne repo: **`lazniak/Jev-UltraCuse` (prywatne, 2026-09-20)**; **do zrobienia**: `main` chroniony (PR + squash), CI: `cargo fmt --check`, `clippy -D warnings`, `test`, `build --release` na `windows-latest` | zielony pierwszy PR | in progress | fable |
