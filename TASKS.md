...
| 0.4 | 0 | R2: `ultracuse bench-jev` vendor plain + hedged done; **do zrobienia**: OpenRouter (klucz `JEVUSE_API_KEY` wygasł — potrzebny nowy `OPENROUTER_API_KEY`), N=120/240, hedge adaptacyjny | `bench/R2-jev.md` | in progress | fable |
